...
output "file_system_arn" {
  ...
  value       = try(aws_fsx_lustre_file_system.this[0].arn, aws_fsx_ontap_file_system.this[0].arn, null)
}

output "file_system_dns_name" {
  description = "DNS name for the file system, e.g., `fs-12345678.fsx.us-west-2.amazonaws.com`"
  value       = try(aws_fsx_lustre_file_system.this[0].dns_name, aws_fsx_ontap_file_system.this[0].dns_name, null)
}
...
output "file_system_id" {
  ...
  value       = try(aws_fsx_lustre_file_system.this[0].id, aws_fsx_ontap_file_system.this[0].id, null)
}
...
output "file_system_network_interface_ids" {
  ...
  value       = try(aws_fsx_lustre_file_system.this[0].network_interface_ids, aws_fsx_ontap_file_system.this[0].network_interface_ids, [])
}
